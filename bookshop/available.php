...
<body>
    <div class="container-fluid">
        <?php navbar(); ?>
        <h1 class="text-center mt-3">Availble Books</h1>


        <div class="search_box">
            <div class="row_search">
                <input class="book_search" type="text" id="input-box" placeholder=" Book/Author Name" autocomplete="off">
