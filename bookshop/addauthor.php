...
if (isset($_POST['add'])) {
    $name = $_POST['name'];
    $sql1 = "INSERT INTO author (author_name) VALUES ('$name')";
    $result = mysqli_query($connection, $sql1);
    if ($result) {
        echo "<script type='text/javascript'>alert('Success'); window.location.href = 'addauthor.php';</script>";
    } else {
...
<body>
    <?php navbar(); ?>
    <div class="container">
        <h2 class="m-5">Add New Author</h2>
        <form method="POST">
            <div class="mb-3">
