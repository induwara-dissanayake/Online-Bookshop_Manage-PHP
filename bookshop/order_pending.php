...
<body>
    <div class="container-fluid">
        <?php navbar(); ?>
        <h1 class="text-center mt-3">Pending Orders</h1>


        <div class="search_box">
            <div class="row_search">
                <input class="book_search" type="text" id="input-box" placeholder="Customer Name/ID" autocomplete="off">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function loadBooks(query = '') {
                fetch('search_order_pending.php', {
                    method: 'POST',
                    headers: {
